...
class ReportService {
  ...
  /// Calls Edge Function to generate an AI Text Trend Report
  Future<String> generateAITrendReport(String storeId, DateTime start, DateTime end) async {
    try {
      ...
      if (response.status == 200 && response.data != null) {
        ...
        throw Exception("Gagal mendapatkan respons AI. Status: ${response.status}");
      }
    } catch (e) {
